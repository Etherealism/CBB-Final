...
<?php
	...
	$id = $_GET['editid'];
	$sql1 = "SELECT * FROM request_info WHERE id = $id";
	...
	if(isset($_POST['submit']))
	{
		...
		$addr = $_POST['addr'];
		$email = $_POST['email'];
		$sql = "UPDATE request_info SET name='$name', num='$cnum', address='$addr',email='$email' WHERE id='$id'";
...
<div id="navbar">
    ...
    <br>
    <br>
    <h2>EDIT REQUESTER'S INFORMATION</h2>
</div>
    ...
    <form action = "#" method="POST">
        ...
        <p>
                    ...
                    <div class="row">
                        ...
                        <select name="blood type" id="blood type" name="btype" value="<?php echo @$btype;?>"disabled>
        ...
        <div class="input-box button"> <a href="Admin_Request.php" style="text-decoration:none"><input type="button" name=""  value="Back">
            </a>
        </div>
        <div id="footer"><br>
