<!DOCTYPE html>
<html lang="en">
<title>Edit Inventory - CBB</title>
<meta charset="UTF-8">
...
<?php
	...
	$id = $_GET['editid'];
	$sql1 = "SELECT * FROM blood_inventory WHERE id = $id";
	...
	{
		$bpacks = $_POST['bpacks'];
		$sql2 = "UPDATE blood_inventory SET blood_packs = '$bpacks' WHERE `blood_type` = '$btype'";
		$result1 = mysqli_query($con,$sql2);

		if($result1)
		{
			echo "<script type='text/javascript'>alert('Successfully Edited');
			window.location='Admin_inventory.php';
			</script>";
		}
		else
		{
...
<div class="main">
    ...
    <form action = "#" method = "POST">
        <div class="row">
            ...
            <select id="blood type" name="btype" value="<?php echo @$btype;?>"disabled>
        ...
        <div class="row">
            ...
            <input type="text" id="blood amount" name="bpacks" size="20" maxlength="50" placeholder="Enter Amount"value = "<?php echo @$bpacks;?>" enabled> </br> </br>
        </div>
        <br>
        ...
        <div class="input-box button"> <a href="Admin_Inventory.php" style="text-decoration:none"><input type="button" name=""  value="Back">
            </a>
        </div>
        <div id="footer"><br>
