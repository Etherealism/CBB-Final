...
if (isset($_POST['submit'])) {
    ...
    // Insert donor record
    $sql = "INSERT INTO donors (name, num, address, email, blood_type, blood_amount, status)
    ...
    <div id="navbar">
        <div class="w3-bar w3-red w3-card w3-left-align w3-large">
            ...
            <div class="w3-right w3-hide-small">
                ...
                <a href="DonateForm.php" class="w3-bar-item w3-hide-small w3-padding-large w3-white"style="text-decoration:none">Donor</a>
