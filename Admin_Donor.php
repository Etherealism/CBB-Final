...
<div class="main">
    <br>
    <button class="button"><a href="Admin_Add_Donor.php" style="text-decoration:none;color:white;">Add Donor</a></button>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if ($status == 0) {
                        echo "<tr>
                            ...
                            <td>$date</td>
                            <td>
                                <button><a href='Admin_Edit_Donor.php?editid=$id' style='color:white;text-decoration:none;'>Edit</a></button>
                                <button><a onclick=\"return confirm('Do you want to delete this record?');\" href='donor_delete.php?deleteid=$id' style='color:white;text-decoration:none;'>Delete</a></button>
                            </td>
                        </tr>";
                    }
                }
