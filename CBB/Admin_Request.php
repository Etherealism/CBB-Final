...
<div id="navbar">
    <div class="w3-bar w3-red w3-card w3-left-align w3-large">
        ...
        <div class="w3-right w3-hide-small">
            ...
            <a href="Admin_Request.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-white">Request</a>
        </div>
    </div>
</div>
<div class="main">
    <br>
    <button class="button"><a href="Admin_Add_Request.php" style="text-decoration:none">Add Request</a></button>
    <table id="customers">
        <tr>
            ...
            <th scope="col" width="35px">Blood Packs Requested</th>
  		...
  		if ($result)
  		{
  			while($row = mysqli_fetch_assoc($result))
  			{
  				...
  				if ($status == 0)
  				{
				      ...
				      <td>Pending</td>
              <td>
              <button><a href="req_approve_del.php?approveid='.$id.'">Approve</a></button>
              <button><a href="Admin_Edit_Request.php?editid='.$id.'">Edit</a></button>
              <button><a onclick="javascript:return confirm(`Do you want to delete this record?`);" href="req_approve_del.php?deleteid='.$id.'">Delete</a></button>
              </td>
				      </tr>'; 
  				}
  				elseif ($status == 1)
